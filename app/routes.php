...
Route::post('/adedit', 'HomeController@adedit');
Route::post('/addelete', 'HomeController@addelete');
Route::post('/saveadedit', 'HomeController@saveadedit');
...
Route::get('savead', 'HomeController@home');
